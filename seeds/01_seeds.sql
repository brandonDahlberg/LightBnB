...
VALUES (1, 'Penthouse', 'Ballin pad', 'Photo of kitchen/living room', 'Photo from street', 321, 2, 3, 4, 'Singapore', 'Oak', 'ACity', 'Punggol', 'X9T 5E7', TRUE),
(1, 'Mansion', 'Super Ballin pad', 'Photo of gold toilet', 'Photo taken from my helicopter', 420, 6, 7, 10, 'US of A', 'Hollywood Blvd', 'LA', 'California', 'W0N LYF', TRUE),
(1, 'Cute Cabin in the Woods', 'Cute lil cabin.', 'Photo of out house', 'Photo of house from the forests edge', 50, 2, 1, 3, 'Canada', 'Forest rd', 'AcornRidge', 'BC', 'F0R E5T', TRUE);
